  ...
  .directive('guitarFret', function () {
    return {
      ...
      link: function postLink(scope, element, attrs) {
          ...
          scope.selectedScaleNote = null;
          scope.selectedChordNote = null;
          ...
          scope.selectedScale = null;  
           ...
           /*	scope.string1 = 7;
        	...
        	scope.strings = [7,2,10,5,0,7];
      		...
      		//!!!FUNCTION!!!
      		//Picking a chord 
      		scope.pickChord = function(chord,$index){
          ...
          scope.highLightScaleNote = function(index){
            scope.selectedScaleNote = index;
          };
          scope.highLightScale = function(index){
            scope.selectedScale = index;
          };
          scope.highLightingChordNote = function(index){
            scope.selectedChordNote = index;
          };
          scope.highLightingChord = function(index){
            scope.selectedChord = index;
            console.log(scope.selectedChord);
          };
